...
void createScene(){
	...
	//地面
	{
		Material mat(Colour(0.6f,0.6f,0.6f),Colour(0.2f,0.2f,0.2f),Colour(0.5f,0.5f,0.5f),100.0f);
			
		RayPlane* planegeom = new RayPlane(Plane(Vec3(0,1,0), planedist));
...
int main(int argc,char** argv)
{
	...
	glutCreateWindow("数字键控制光线追踪次数 ,a,s控制光源位置");
	Init();
